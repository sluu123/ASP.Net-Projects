    ...
    public partial class ProductMaintenance : System.Web.UI.Page
    {
        ...
        protected void ButtonUploadImage_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                FileUpload1.SaveAs(HttpContext.Current.Server.MapPath(".") + @"\Images\" + filename);
        ...
        private string AddPictureToProducts(string filename)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@QtyOnHand", Convert.ToInt32(TextQty.Text));
                ...
                return TextProductID.Text = Convert.ToString(identValue);
            }
            catch (Exception ex)
            {
